...
function LoginComp() {
  ...
  const URL = "https://api.igospel.com.ng/dev/auth/signin/";
        ...
        <div className="w-full flex flex-col items-center h-full justify-center">
          ...
          <div className="bg-[#0E0E0F] border-[1px] border-[#1e1e1e49] w-[425px] rounded-2xl px-4 py-10">
            <div>
              ...
              <div className="mt-1">
                <Link to="/auth/reset_password" className="text-[#FF375F] font-sf-reg text-xs">
                  Forgot Password ?
                </Link>
              </div>
          ...
          <div className="mt-1">
            <Link to="/auth/signup" className="text-white font-sf-reg text-xs">
              Don't have an account ? <span className="text-[#FF375F]">Signup</span>
            </Link>
          </div>
        </div>
