                            ...
                            <div className='bg-[#0E0E0F] border-[1px] border-[#1e1e1e49] w-[425px] rounded-2xl px-10 py-10'>
                                <div>
                                    ...
                                    <form>
                                        {/* password input one  */}
                                        <div className='mb-5'>
                                            <label htmlFor="password" className='text-white font-sf-reg text-xs'>New Password</label>
                                            <div className='border-[1px] border-white bg-transparent pl-2 mt-2 flex flex-row items-center rounded-md justify-between'>
                                                <input value={password} onChange={handlePassword} type={showPassword ? 'text' : 'password'} placeholder='Enter new password' className='w-full h-10 bg-transparent flex-1 outline-0 text-white font-sf-reg text-sm' style={{ borderWidth: '0', outline: 'none' }} />
                                        ...
                                        {/* password input two  */}
                                        <div className='mb-7'>
                                            <label htmlFor="confirm" className='text-white font-sf-reg text-xs'>Confirm Password</label>
                                            <div className='border-[1px] border-white bg-transparent pl-2 mt-2 flex flex-row items-center rounded-md justify-between'>
                                                <input value={confirm} onChange={handleConfirm} type={showConfirmPassword ? 'text' : 'password'} placeholder='Confirm new password' className='w-full h-10 bg-transparent flex-1 outline-0 text-white font-sf-reg text-sm' style={{ borderWidth: '0', outline: 'none' }} />
                                        ...
                                        <button onClick={handleSubmit} type="submit" className='w-full h-10 bg-[#FF375F] text-white font-sf-med text-sm rounded-md flex flex-row items-center justify-center'>
                                            {loading ? (
                                                <div className='flex items-center justify-center'>
                                                    <Puff height="24" width="24" radius={1} color="white" ariaLabel="puff-loading" wrapperStyle={{}} wrapperClass="" visible={true} />
                                                </div>
                                            ) : 'Continue'}
                                        </button>
                                    </form>
